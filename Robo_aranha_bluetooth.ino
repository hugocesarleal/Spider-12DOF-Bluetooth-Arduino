  ...
  case 'F':
    ...
    delay (150);
      ...
      case 'm':
        ...
        break;
      case 'X':
       if (flagX == 0) { // Verifica se a dança já foi executada
          body_dance(10);
          stand();  // Executa a dança
          flagX = 1;  // Marca que a dança foi executada
        }else{
          flagX =0;
        }
        cmd = ' ';
        break;
      case 'Y':
       if (flagY == 0) { // Verifica se a dança já foi executada
          hand_wave(3);
            // Executa a dança
          flagY = 1;  // Marca que a dança foi executada
        }else{
          flagY =0;
        }
        cmd = ' ';
